...
const InputField = ({
  ...
  error, icon: Icon, showToggle, onToggle, showPassword, hint,
}) => (
  <div className="mb-5">
...
const SignUp = () => {
  ...
  const [form, setForm] = useState({
    email: '', password: '', name: '',
    dob_day: '', dob_month: '', dob_year: '', gender: '',
  })
  ...
  const handleNext = async (e) => {
    ...
    if (step < TOTAL_STEPS - 1) {
      ...
      signup({ email: form.email, name: form.name, gender: form.gender, avatar: null })
      setLoading(false)
      navigate('/')
    }
  }
      ...
      <span className="text-white font-black text-xl tracking-tight hidden sm:block">
        ...
        <div className="flex-1 flex justify-center px-4 py-10">
          ...
          >
            ...
            <p className="text-center text-[#878787] text-sm mb-10">to start listening</p>
            ...
            {/* Step title */}
            <h2 className="text-xl font-black text-white mb-6">{stepTitles[step]}</h2>
            ...
            <form onSubmit={handleNext} noValidate>
              <AnimatePresence mode="wait">
                ...
                {step === 1 && (
                  ...
                  >
                    ...
                    <div className="mb-5">
                      ...
                      <div className="grid grid-cols-3 gap-2">
                        ...
                        <input
                          ...
                          value={form.dob_day} onChange={handleChange('dob_day')}
                        ...
                        <input
                          ...
                          value={form.dob_year} onChange={handleChange('dob_year')}
                          className="w-full bg-[#121212] border border-[#878787] rounded-md py-3.5 px-3 text-white text-sm outline-none focus:border-white transition-colors"
                        />
                      </div>
                      {errors.dob && (
                    ...
                    {/* Gender */}
                    <div className="mb-5">
                      <label className="block text-sm font-bold text-white mb-3">What's your gender?</label>
                      <div className="flex flex-wrap gap-x-6 gap-y-3">
                        {['Man', 'Woman', 'Non-binary', 'Prefer not to say'].map((g) => (
                          <label key={g} className="flex items-center gap-2 cursor-pointer group">
                            ...
                            <span className="text-white text-sm select-none">{g}</span>
                          </label>
                        ))}
                      </div>
                      {errors.gender && (
              ...
              <div className="mt-8 space-y-3">
                ...
                >
                  ...
                  ) : step < TOTAL_STEPS - 1 ? 'Next' : 'Sign Up'}
                </motion.button>
